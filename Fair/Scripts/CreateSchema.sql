...
CREATE TABLE "Searches" (
    "SearchId" integer NOT NULL GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE "Revisions" (
    "RevisionId" integer NOT NULL GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE "Documents" (
    "DocumentId" integer NOT NULL GENERATED BY DEFAULT AS IDENTITY,
    "SearchId" integer NOT NULL,
    "Name" character varying(255) NOT NULL,
...
VALUES ('20190927210320_InitialSchema', '3.0.0');
